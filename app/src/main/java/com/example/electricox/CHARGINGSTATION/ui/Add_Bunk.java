...
public class Add_Bunk extends Fragment {
    ...
    private Spinner onSiteSupportSpinner  ,charging_spinner;
    ...
    private String charging_spinnerr;
...
//charging_spinner
        ...
        charging_spinner = root.findViewById(R.id.charging_spinner);
        ...
        locationMarker=root.findViewById(R.id.locationIcon);
        ...
        LONG=root.findViewById(R.id.Long);
    ...
    private void ValidateBUNKDeatails()
    {
        ...
        charging_spinnerr = charging_spinner.getSelectedItem().toString();
        ...
        if (businessHours.isEmpty() || bunkName.isEmpty()  ||
                emergencyContact.isEmpty() || onSiteSupport.isEmpty() ||charging_spinnerr.isEmpty()|| bal.equals("null") ||
                address.getText().toString().isEmpty() || LAT.getText().toString().isEmpty() ||
                LONG.getText().toString().isEmpty() || !isLocationValid()) {
            Toast.makeText(getContext(), "Please fill in all fields ", Toast.LENGTH_SHORT).show();
        } else {
            // All fields are valid, proceed to addPackage method using Volley
            addPackage();
        }
    }
    ...
    private void addPackage()
    {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.SERVERUrl, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("charging_spinnerr", charging_spinnerr);
